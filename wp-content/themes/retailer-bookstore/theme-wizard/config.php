...
$config['page_slug'] 	= 'retailer-bookstore';
...
$config['steps'] = array(
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'retailer-bookstore' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'retailer-bookstore' ), // Button text
