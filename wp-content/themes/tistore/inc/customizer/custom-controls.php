...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class wpdevart_tistore_Section_Premium extends WP_Customize_Section {
	...
	class Wpdevart_Toggle_Switch_Custom_control extends WP_Customize_Control {
		public $type = 'wpdevart_tistore_toggle_switch';
    ...
    class Wpdevart_Slider_Custom_Control extends WP_Customize_Control {
		public $type = 'wpdevart_tistore_slider_control';
		public function render_content() {
		?>
    ...
    class Wpdevart_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		public $type = 'wpdevart_tistore_image_radio_button';
		public function render_content() {
		?>
	...
	class Wpdevart_Premium_Features_List extends WP_Customize_Section {
		...
		public function json() {
			...
			$json['upsell_text']       = __( 'Upgrade Now', 'tistore' );
	...
	class Wpdevart_Premium_Features_Control_List extends WP_Customize_Control {
		...
		public $type = 'control_wpdevart_tistore_premium_features';
		public function render_content() {
			?>
				<div class="control-section-section-features-list">
					...
					<a href="<?php echo apply_filters( 'parent_wpdevart_tistore_premium_features_url', esc_url('https://wpdevart.com/tistore-best-ecommerce-theme-for-wordpress')); ?>" role="button" class="wpdevart-features-button-style" target="_blank"><?php echo esc_html__( 'Upgrade Now', 'tistore' ); ?></a>
				</div>	
			<?php
		}
	}	
