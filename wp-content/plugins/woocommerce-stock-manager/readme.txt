...
Contributors: storeapps, niravmehta, mansi shah, Tarun.Parswani, gomathip, Musilda, abhaypatel01
...
2. Search for 'Stock Manager for WooCommerce'
3. Click 'Install Now'
...
Go to WordPress admin > Stock Manager and click on 'Screen Options' to show/hide any columns in the Stock Manager Table.
...
* Fix: CSV export fails when WooCommerce Product title contains '#'
* Update: POT file
...
* Fix: Unique action name for 'Export' to avoid conflicts
* Fix: Prevent exposure of export data [Thanks to WordPress.org team]
* Update: Strengthen security during export and subscribe process [Thanks to WordPress.org team]
...
= 2.5.6 (26.03.2021) =
* Update: Admin footer text for Stock Manager pages
...
= 2.5.6 =
Admin footer text for Stock Manager pages, Code Improvements, POT file. Recommended upgrade.
